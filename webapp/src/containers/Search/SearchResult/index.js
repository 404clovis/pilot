...
import Credits from '../../Order/Credits'
import Seller from '../../Order/Seller'
import Device from '../../Order/Device'
...
class Order extends React.Component {
  ...
  componentDidMount () {
    fetch('http://localhost:8000/orders/'.concat(this.props.match.params.result.toString()))
